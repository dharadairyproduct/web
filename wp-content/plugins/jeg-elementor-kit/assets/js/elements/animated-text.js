! function(e) {
    ...
    class n extends elementorModules.frontend.handlers.Base {
        ...
        showText(e, t) {
            ...
            if (e.addClass("show-text"), "clip" == i) {
                ...
                n.elements.$dynamic.width(e.width() + 10), n.elements.$dynamic.animate({
                    width: 0
                }, i / 2, (function() {
                    e.removeClass("show-text"), t.addClass("show-text"), n.elements.$dynamic.animate({
                        width: t.width() + 10
                    }, i / 2, (function() {
                        setTimeout((function() {
    ...
    jQuery(window).on("elementor/frontend/init", (() => {
        elementorFrontend.hooks.addAction("frontend/element_ready/jkit_animated_text.default", (e => {
